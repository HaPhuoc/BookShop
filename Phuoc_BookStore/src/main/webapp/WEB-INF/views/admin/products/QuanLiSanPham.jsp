			...
			<div class="row">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="/admin/product">Quản Lí Sản
								Phẩm</a></li>
				...
				<div class="col" style="margin-top: 10px;">
					<form action="">
						<div class="form-inline">
							...
							<a style="float: right" href="/admin/product/add"><i
								class="fas fa-asterisk" aria-hidden="true"></i>Add New Product</a>
						</div>
					</form>
				</div>
			</div>
			...
			<div class="col offset-3 mt-4">
				<table class="table"
					...
					<script>
						...
						function showTableModalDialog(id1, name1, image, price,
								quantity, category, descreption, createdate) {
							$("#productId").text(id1);
							$('#productName1').text(name1);
							$('#productImage1').text(image);
							$('#productPrice1').text(price);
							$('#productQuantity1').text(quantity);
							$('#productCategory1').text(category);
							$('#productDescreption1').text(descreption);
							$('#productCreateDate1').text(createdate);
							$('#talbeId').modal('show');
						}
					</script>
					...
					<div style="margin-top: 100px" class="modal fade" id="talbeId"
						tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
						aria-hidden="true">
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h4 style="color: green" class="modal-title">Thông Tin Sản
										Phẩm</h4>
									<button type="button" class="close" data-dismiss="modal"
										aria-label="Close">
										<span aria-hidden="true">&times;</span>
								...
								<div class="modal-body">
									...
									ID:<span id="productId"></span><br>
									<br> Name:<span id="productName1"></span><br>
									<br> Price: $<span id="productPrice1"></span><br>
									<br> Image: <img alt="" src="/images/">
									<br> Quantity: <span id="productQuantity1"></span><br>
									<br> Category: <span id="productCategory1"></span><br>
									<br> Descreption:
									<h5 id="productDescreption1"></h5>
									<br>
									<br> Create Date: <span id="productCreateDate1"></span><br>
									<br>
					...
					<tbody>
						<c:forEach items="${ productPage.content }" var="list">
							<tr style="font-size: 16px">

								<td><a href="/images/${ list.image}"><img alt=""
										width="50" class="img-fluid"
										src="${pageContext.request.contextPath}/images/${ list.image}"></a></td>
								...
								<td><a data-id1="${list.idProduct}"
									data-name1="${list.name}" data-image="${ list.image }"
									data-price="${ list.price }" data-quantity="${ list.quantity }"
									data-descreption="${ list.descreption }"
									data-category="${ list.category.name }"
									data-createdate="${ list.createDate }"
									onclick="showTableModalDialog(this.getAttribute('data-id1'),
					                                		  this.getAttribute('data-name1'),this.getAttribute('data-image'), 
					                                		  this.getAttribute('data-price'), this.getAttribute('data-quantity'), 
					                                		  this.getAttribute('data-category'), this.getAttribute('data-descreption'),
					                                		  this.getAttribute('data-createdate'))"
									class="btn btn-outline-danger"><i class="fa fa-info"></i></a> <a
									href="/admin/product/edit/${ list.idProduct }"
									class="btn btn-outline-warning"><i class="fas fa-edit    "></i></a>
									<a data-id="${list.idProduct}" data-name="${list.name}"
							...
							<form action="">
								...
								<select name="size" id="size" class="form-control" onchange="this.form.submit()">
									...
									<option selected>${productPage.size}</option>
								</select>
							</form>
						</div>
					...
					<nav aria-label="Page navigation">
						<ul class="pagination justify-content-center">
							<li class="page-item"><a class="page-link "
								href="/admin/product?page=${ productPage.number==productPage.totalPages?productPage.number-1 :0 }"
								aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
									<span class="sr-only">Previous</span>
							</a></li>
							<li class="page-item active"><a class="page-link"
								href="/admin/product?page=${ productPage.number }">${productPage.number}</a></li>
							<li class="page-item"><a class="page-link"
								href="/admin/product?page=${ productPage.number+1 }">${productPage.number+1}</a></li>
							<li class="page-item"><a class="page-link"
								href="/admin/product?page=${ productPage.number+1 }"

	...
	<main class="container">
		...
		<section class="row">
			<div class="col-6 offset-3 mt-4"
				...
				<form:form action="/admin/categories/saveOrUpdate" method="post"
					modelAttribute="categories">

					<c:if test="${ category.isEdit }">
					Id:<br>
						<form:input value="${ layId }" readonly="true" path="idCategory" />
					</c:if>
					<br>
					Name: <br>
					...
					<div class="card-footer text-muted">
						...
						<a class="btn btn-success">List Categories</a>

				...
				<div class="col" style="margin-top: 10px;">
					<form action="">
						<div class="form-inline">
							...
							<a style="float: right" href="/admin/categories/add"><i
								class="fas fa-asterisk" aria-hidden="true"></i>Add New Category</a>
						</div>
					</form>
				</div>
			</div>
		...
		<section class="row">
			<div class="col offset-3 mt-4">
				...
				<div class="form-inline float-left">
					<form action="">
						<label for="size">Page Size</label> <select name="size" id="size"
							...
							<option selected>${categoryPage.size}</option>
						</select>
					</form>
				</div>
					...
					<nav aria-label="Page navigation">
						<ul class="pagination justify-content-center">
							<li class="page-item"><a class="page-link "
								href="/admin/categories?page=${ categoryPage.number==categoryPage.totalPages?categoryPage.number-1 : 0 }"
								aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
									<span class="sr-only">Previous</span>
							</a></li>
							<li class="page-item active"><a class="page-link"
								href="/admin/categories?page=${ categoryPage.number-1 }">${categoryPage.number}</a>
							</li>
							<li class="page-item"><a class="page-link"
								href="/admin/categories?page=${ categoryPage.number+1 }">${categoryPage.number+1}</a>
							</li>
							<li class="page-item"><a class="page-link"
								href="/admin/categories?page=${ categoryPage.number+1 }"

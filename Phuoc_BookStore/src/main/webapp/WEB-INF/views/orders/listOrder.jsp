			...
			<div class="row">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="/admin/orders/bills">Quản Lí Đơn Hàng</a></li>
					...
					<div class="col" style="margin-top: 10px;" >
						<form action="" >
							...
							<div class="form-inline float-left" >
							  <input style="width: 300px;" type="text" class="form-control" name="address" id="address" aria-describedby="helpId" placeholder="Nhập tên cần tìm!">

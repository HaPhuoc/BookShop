			...
			<div class="row">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="/shopping-cart/views">Cart</a></li>
								...
								<table cellspacing="0" class="shop_table cart">
									...
									<tbody>
										...
										<form method="post" action="/shopping-cart/update">
											<input type="hidden" name="id-product" value="${ item.idProduct }">
											<tr class="cart_item">
												<td class="product-remove"><a title="Remove this item"
													class="remove" href="#">${item.idProduct}</a></td>

												<td class="product-thumbnail"><a
													href="/images/${ item.image }"><img width="145"
														height="145" class="shop_thumbnail"
														src="/images/${ item.image }"></a></td>

												<td class="product-name"><a href="/shopping-cart/single-product/${ item.idProduct }">${ item.name }</a>
												</td>

												<td class="product-price"><span class="amount">${ item.price }
														$</span></td>

												<td class="product-quantity">
													<div class="quantity buttons_added">
														<input onblur="this.form.submit()"
															type="number" size="4" class="input-text qty text" name="quantity"
															title="Qty" value="${ item.quantity }" min="0" step="1">
														
													</div>
												</td>

												<td class="product-subtotal"><span class="amount">${ item.price*item.quantity }
														VNĐ</span></td>	
														
														<td class="actions"
												colspan="6">
												
                                                <a class="btn btn-success" href="/shopping-cart/delete/${ item.idProduct }">Delete</a>
                                ...
                                <table cellspacing="0">
                                    <tbody>
                                        ...
                                        <tr class="order-total">
                                            <th>Order Total</th>
                                            <td><strong><span
														class="amount"> ${ amount }VNĐ</span></strong> </td>
											<td><a class="btn btn-success" href="/shopping-cart/checkout">Check Out</a></td>
                                        </tr> <br>

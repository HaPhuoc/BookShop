...
import fptu.phuochg.library.exception.StorageException;
import fptu.phuochg.library.exception.StorageFileNotFoundException;
import fptu.phuochg.library.service.StorageService;

@Service
public class FileSystemStorageServiceIml implements StorageService {
	...
	public FileSystemStorageServiceIml(StorageProperties properties) {
